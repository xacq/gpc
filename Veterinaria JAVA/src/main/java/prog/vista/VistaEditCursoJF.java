...
public class VistaEditCursoJF extends javax.swing.JFrame {

    ArrayList<Curso> cursos;      
    
    public VistaEditCursoJF(ArrayList<Curso> cursos, ArrayList<Doctor> doctores) {
        this.cursos = cursos;
        initComponents();
        LlenarCombo1();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Escoger un curso para actualizar");
        ...
        jLabel4.setText("Fecha Curso");

        jTextField2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel5.setText("Horas del Curso");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (Curso obj : cursos){
            if (obj.getNombre() == null ? Name == null : obj.getNombre().equals(Name)){
                ...
                jTextField4.setText(obj.getCodigovet());
                jTextField2.setText(obj.getFecha());
                jTextField3.setText(String.valueOf(obj.getHoras()));
            ...
            if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty()) {
                ...
                for (Curso obj : cursos) {
                    if (obj.getCodigo().equals(jTextField1.getText())) {
                        obj.setNombre(jTextField5.getText());
                        obj.setFecha(jTextField2.getText());
                        obj.setHoras(Integer.parseInt(jTextField3.getText()));
                        obj.setDescripcion(jTextArea1.getText());
                    }
                }
                JOptionPane.showMessageDialog(null,"CURSO ACTUALIZADO","Mensaje", JOptionPane.INFORMATION_MESSAGE);                     
                dispose();
            }
