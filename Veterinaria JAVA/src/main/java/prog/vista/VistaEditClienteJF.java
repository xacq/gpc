...
public class VistaEditClienteJF extends javax.swing.JFrame {

    ArrayList<Cliente> clientes;

    public VistaEditClienteJF(ArrayList<Cliente> clientes) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Escoger un cliente para actualizar");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null,"CLIENTE ACTUALIZADO","Mensaje", JOptionPane.INFORMATION_MESSAGE);     
                dispose();
            }
