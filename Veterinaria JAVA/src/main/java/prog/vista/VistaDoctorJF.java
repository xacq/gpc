...
public class VistaDoctorJF extends javax.swing.JFrame {

    ArrayList<Doctor> doctores;
    
    public VistaDoctorJF(ArrayList<Doctor> doctores) {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Ingrese los datos del Doctor");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty() ){
                ...
                doctor.Controlador(jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),jTextField4.getText(),jTextField5.getText(),this.doctores);
                dispose();
            }
