...
import prog.controlador.ControladorRemedio;
import prog.modelo.Remedio;

public class VistaRemedioJF extends javax.swing.JFrame {
    ArrayList <Remedio> remedios;
    
    public VistaRemedioJF(ArrayList <Remedio> remedios) {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Ingrese el remedio correspondiente");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty()){
                ...
                ControladorRemedio remedio = new ControladorRemedio();
                remedio.Controlador(jTextField1.getText(), jTextField2.getText(), jTextField3.getText(), jTextField4.getText(), this.remedios);
                dispose();
            }
