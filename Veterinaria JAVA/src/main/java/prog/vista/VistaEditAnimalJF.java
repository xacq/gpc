...
public class VistaEditAnimalJF extends javax.swing.JFrame {

    ArrayList<Animal> mascotas;    
    
    public VistaEditAnimalJF(ArrayList<Animal> mascotas) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Escoger una mascota para actualizar");
        ...
        jLabel10.setText("1 - Perro / 2 - Gato ");

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setText("1 - MACHO / 2 - HEMBRA");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (Animal obj : mascotas){
            if (obj.getNombre() == null ? Name == null : obj.getNombre().equals(Name)){
                ...
                jTextField3.setText(String.valueOf(obj.getTipo()));
                jTextField4.setText(String.valueOf(obj.getPeso()));
                jTextField5.setText(String.valueOf(obj.getGenero()));
                jTextField6.setText(String.valueOf(obj.getedad()));
            }
        }
            ...
            if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty()) {
                ...
                for (Animal obj : mascotas) {
                    if (obj.getCodigo().equals(jTextField1.getText())) {
                        ...
                        obj.setTipo(Integer.valueOf(jTextField3.getText()));
                        obj.setPeso(Float.valueOf(jTextField4.getText()));
                        obj.setGenero(Integer.valueOf(jTextField5.getText()));
                        obj.setFechaNacimiento(Integer.valueOf(jTextField6.getText()));
                       
                    }
                }        
                JOptionPane.showMessageDialog(null,"MASCOTA ACTUALIZADA","Mensaje", JOptionPane.INFORMATION_MESSAGE);        
                dispose();
            }
