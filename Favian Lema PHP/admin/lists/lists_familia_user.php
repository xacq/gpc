         ...
         <legend class="form_title maximus" style="text-align:right;">lista de clientes</legend>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query = "SELECT * FROM fav_clientes WHERE fav_cli_tipo = 'familia' ORDER BY fav_cli_fecha_creacion desc";
                  ...
                  while ($row = mysqli_fetch_array($resultado)){?>
                    <tr>
                      ...
                      <td><a href="../edit/edit_user.php?id=<?php echo $row['fav_cli_id']?>" class="marca4" onclick="return confirmar('¿Está seguro que desea editar el registro?')"><i class="tf-ion-ios-compose-outline"></i> EDIT</td>
                    </tr>
                  <?php   
                  }
                  ?>
