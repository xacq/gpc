...
import prog.controlador.ControladorCliente;
import prog.modelo.Cliente;

public class VistaClienteJF extends javax.swing.JFrame {

        ArrayList<Cliente> clientes;
    public VistaClienteJF(ArrayList<Cliente> clientes) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField4.getText().isEmpty() || jTextField5.getText().isEmpty() ){
            ...
            cliente.Controlador(jTextField1.getText(),jTextField2.getText(),jTextField3.getText(),jTextField4.getText(),jTextField5.getText(),this.clientes);
            dispose();            
        }
